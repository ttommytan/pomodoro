      ...
      {settings && (
        <div className="outer-popup">
          <div className="inner-popup">
            <button className="exit" onClick={() => setSettings(false)}>
              Close
            </button>
            <h1>Settings</h1>
              ...
              <div className="settings-element">
                ...
                <div>
                  ...
                  <label htmlFor="actual-background" className="actual-btn">
                    <FontAwesomeIcon className="icon-folder" icon={faFolder}></FontAwesomeIcon>
                  </label>
                </div>
              </div>
              <div className="settings-element">
                ...
                <div>
                  ...
                  <label htmlFor="actual-sound" className="actual-btn">
                    <FontAwesomeIcon className="" icon={faFolder}></FontAwesomeIcon>
                  </label>
                </div>
              </div>
            </div>
