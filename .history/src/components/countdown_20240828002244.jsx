        ...
        <div className="outer-popup">
          <div className="inner-popup">
            ...
            <ol>
              ...
              <li>
                <b>Customize Background:</b> Double-click the Refresh button to
                cycle through different backgrounds.
              </li>
              <li>
                <b></b>Color Swap: Double-click the timer to switch its color, along
                with the buttons, between white and black.
              </li>
              <li>
