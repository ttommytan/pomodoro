      ...
      {settings && (
        <div className="outer-popup">
          <div className="inner-popup">
              <button className="exit"onClick={()=> setSettings(false)}>Close</button>
              <h1>Settings</h1>
              <div>
                <div className="settings-element">Backgrounds <button>upload</button></div>
                <div className="">Sound <button>upload</button></div>
              </div>
          </div>
        </div>
      )}
