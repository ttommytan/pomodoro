...
function Countdown({ givenTime }) {
  ...
  return (
    <>
      ...
      <div
        className="next-container" id="next-container"
        style={{
      ...
      >
        ...
        >
          ...
          <FontAwesomeIcon onClick={()=>setFullScreen((prev) => !prev)} className="icon-fullscreen" 
          style={{color: white ? 'white' : 'black', opacity: !isVisible ? "hide" : 1 }} icon={faExpand}/>
        </div>
      </div>
    </>
  );
