      ...
      {settings && (
        <div className="outer-popup">
          <div className="inner-popup">
            ...
            <h1>Tips & Tricks</h1>
            <ol>
              <li>Double click pomodoro or short break for a longer session</li>
              <li>Double click refresh to cycle through backgrounds</li>
              <li>Double click the timer to alternate between white or black color theme</li>
              <li>Click on any of the corners of the screen to move the timer</li>
            </ol>
          </div>
          {notification && (
