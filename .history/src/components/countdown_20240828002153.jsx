      ...
      {settings && (
        <div className="outer-popup">
          <div className="inner-popup">
            ...
            <ol>
              <li>
                <b></b>Alternate Timers: Double-click the Pomodoro or Short Break
                buttons to toggle between 25/50 minutes or 5/10 minutes.
              </li>
              <li>Double click refresh to cycle through backgrounds</li>
              <li>
                Double click the timer to alternate between white or black color
                theme
              </li>
              <li>
                Click on any of the corners of the screen to move the timer
              </li>
            </ol>
          </div>
          {notification && (
