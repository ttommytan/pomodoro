  ...
  return (
    ...
    <div id="everything" onMouseEnter={showButtons} onMouseLeave={hideButtons} className={gridContainerName()}>   
          ...
          <div onMouseEnter={showButtons} onMouseLeave={hideButtons} className={buttonName()}>
              ...
              <button onDoubleClick={()=> index >= urls.length - 1 ? setIndex(0) : setIndex(index+1)} className={`buttons${!white ? 'black' : ''}`}onClick = {() => {pomo ? setTime(1500) : setTime(10); setPause(true)}}>refresh</button>
          </div>    
      </div>
